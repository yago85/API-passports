...
// GetNotes Добавьте обработчик чтения заметок
...
// CreateNotes Добавьте обработчик создания заметки
...
// GetNote Добавьте обработчик получения заметок
...
// UpdateNote Добавьте обработчик примечаний об обновлении
...
// DeleteNote Добавьте обработчик удаления заметок
